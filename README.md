...
11. Finally, I created security groups and assigned users to them. Security groups let you assign permissions once at the group level, like IT-Admins can access the file server, instead of managing access per individual user:
